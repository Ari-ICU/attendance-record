...
const seedMockData = async () => {
    try {
        ...
        if (payrollCount < 6 && employeeDocs.length >= 6) {
            ...
            const payslipsSeed = [
                {
                    ...
                    deductions: {
                        ...
                        otherDeductions: 0,
                        totalDeductions: 243.07,
                    },
                    attendanceMetrics: {
                        totalWorkingHours: 168.0,
                        targetWorkingHours: 176,
                        targetDays: 22,
                        presentDays: 20,
                        lateDays: 1,
                        lateMinutes: 15,
                ...
                },
                {
                    ...
                    deductions: {
                        ...
                        socialSecurity: 54.0,
                        otherDeductions: 0,
                        totalDeductions: 209.0,
                    },
                    attendanceMetrics: {
                        totalWorkingHours: 164.0,
                        targetWorkingHours: 176,
                        targetDays: 22,
                        presentDays: 19,
                        lateDays: 2,
                ...
                },
                {
                    ...
                    deductions: {
                        ...
                        socialSecurity: 56.0,
                        otherDeductions: 0,
                        totalDeductions: 226.0,
                    },
                    attendanceMetrics: {
                        totalWorkingHours: 174.0,
                        targetWorkingHours: 176,
                        targetDays: 22,
                        presentDays: 19,
                        lateDays: 3,
                ...
                },
                {
                    ...
                    deductions: {
                        ...
                        socialSecurity: 38.9,
                        otherDeductions: 0,
                        totalDeductions: 143.65,
                    },
                    attendanceMetrics: {
                        totalWorkingHours: 162.0,
                        targetWorkingHours: 176,
                        targetDays: 22,
                        presentDays: 19,
                        lateDays: 1,
            ...
            console.log('✅ September 2026 Payroll & Payslips seeded with detailed attendance metrics');
        }
