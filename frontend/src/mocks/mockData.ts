...
export const MOCK_REPORT_ANALYTICS = {
    ...
    departmentBreakdown: [
        ...
        { name: 'Product & Design', total: 32, present: 31, rate: 96.9 },
...
export const MOCK_LEAVE_REQUESTS: LeaveRequestItem[] = [
    ...
    { id: 'lv_002', employeeName: 'Sarah Jenkins', department: 'Product & Design', type: 'Sick Leave', startDate: '2026-09-12', endDate: '2026-09-13', days: 2, reason: 'Medical recovery & doctor appointment.', status: 'pending' },
...
export const MOCK_OVERTIME: OvertimeItem[] = [
    { id: 'ot_001', employeeName: 'Thoeurn Ratha', department: 'Engineering & IT', date: '2026-09-10', startTime: '17:30', endTime: '20:30', hours: 3.0, project: 'Biometric Gateway Upgrade', reason: 'Office IoT sensor firmware sync and database patch.', status: 'approved' },
    { id: 'ot_002', employeeName: 'Sarah Jenkins', department: 'Product & Design', date: '2026-09-09', startTime: '17:00', endTime: '19:00', hours: 2.0, project: 'Design System Sprint', reason: 'Design component library release and UX review.', status: 'pending' },
    { id: 'ot_003', employeeName: 'David Miller', department: 'Operations & Facilities', date: '2026-09-08', startTime: '18:00', endTime: '21:30', hours: 3.5, project: 'Corporate Security Audit', reason: 'Night gate check-in turnstile diagnostic.', status: 'approved' },
];
